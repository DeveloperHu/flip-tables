...
public class FlipTableAsciiTableFormatTest {
    ...
    public void empty() {
        ...
        String expected = "" +
                ...
                "| (empty)       |\n" +
                "+------+--------+\n";
        String of = FlipTable.of(new AsciiTableFormat(), headers, data);
    ...
    public void nested() {
        ...
        String nested = FlipTable.of(new AsciiTableFormat(), innerHeaders, innerData);
        ...
        String expected = "" +
                ...
                "| +-----+-----+ | +-----+-----+ |\n" +
                "+---------------+---------------+\n";
        String of = FlipTable.of(new AsciiTableFormat(), outerHeaders, outerData);
        System.out.println(of);
        assertThat(of).isEqualTo(expected);
    }
    ...
    public void chinese() {
        String[] innerHeaders = {"One", "Two"};
        String[][] innerData = {{"1", "2中文"}, {"1 这是很长的中文，非常长非常长非常长非常长非常长非常长非常长非常长非常长非常长非常长非常长", "2 This is english"}};
        String nested = FlipTable.of(new AsciiTableFormat(), innerHeaders, innerData);
        String[] outerHeaders = {"Left中文", "Right"};
        String[][] outerData = {{nested, nested}};
        String expected = "" +
                "+====================================================================================================================+====================================================================================================================+\n" +
                "| Left中文                                                                                                           | Right                                                                                                              |\n" +
